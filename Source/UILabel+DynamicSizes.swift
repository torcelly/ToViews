...
public extension UILabel {
    ...
    public func widthNeeded(withAttributes attr: [NSAttributedString.Key: Any]?) -> CGFloat {
    ...
    public func heightNeeded(withAttributes attr: [NSAttributedString.Key: Any]?) -> CGFloat {
